...
usethis::use_git_config(
    user.name = "ceciliacerrilla",
    user.email = "cecilia.cerrilla@gmail.com")
...
## Final Processing Script (development of this script with all annotations in development.R)
